...
img_instr.setText("In each trial, a + sign will appear in the center of the screen, followed by a pair of faces.\n \n Your task only consists in looking at those faces. We might ask you questions about those faces later.\n \n \n Press any key to start or escape to leave")
img_instr.draw()
win.flip()
